...
marvel = cPickle.load(open("../input/smallG.pkl"))
characters = cPickle.load(open("../input/smallChr.pkl"))
...
def create_weighted_graph(bipartiteG, characters):
    ...
    for char1 in characters:
        ...
        for char2 in characters:
            if char1 is char2: continue
            comics2 = set(bipartiteG[char2].keys())
            G[char1][char2] = 1.*len(comics1 & comics2)/len(comics1 | comics2)
            if G[char1][char2] == 0.: G[char1][char2] = None
    return G
